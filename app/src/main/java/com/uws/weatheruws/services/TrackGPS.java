package com.uws.weatheruws.services;
...
public class TrackGPS extends Service implements LocationListener {
     ...
     * */
    //ctext is the variable that stores the reference to the activity because this is a pure java class
    //if dialog is created inside and Activity, replace ctext with  MainActivity.this
